    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
      ...
      <div class="space-y-4">
        <div class="flex items-center">
          <img src="{{ asset('assets/images/logo.png') }}" class="h-18 w-auto" alt="Corpotech logo" />
        </div>
        <p class="text-gray-400">Technologia dla Twojego biznesu i domu</p>
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-2">
          ...
          <li><a href="/uslugi/systemy-teletechniczne" class="text-gray-400 hover:text-white transition">Systemy teletechniczne</a></li>
